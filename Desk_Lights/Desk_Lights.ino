...
void setup() {
    ...
    pinMode(PIN_SLIDE_POT_A, INPUT ); //init POT
    pinMode(SENSOR_PIN, INPUT); //init touch sensor
     Serial.begin(9600);
}
...
void loop()
{
    ...
    if (lightState == true) {
      ...
      FastLED.setBrightness( value_slide_pot_a / 10 );
...
void updateBrightnessfromPOT( int value_slide_pot_a) 
{
